...
@NonNullApi
public class CyuriProjectDependency extends DelegatingProjectDependency {

    @Inject
    public CyuriProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
